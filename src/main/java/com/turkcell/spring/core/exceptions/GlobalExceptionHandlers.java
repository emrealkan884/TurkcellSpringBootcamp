...
public class GlobalExceptionHandlers {
    ...
    //Uygulamanın neresinde olursa olsun fırlayan runtime exception'ları yakalaması için ExceptionHandler ekle
    //ExceptionHandler metodu içerisinde bu metodun hangi exception türünü handle edeceğini söyle
    //Yani uygulamanın herhangi bir yerinde  MethodArgumentNotValidException fırlarsa bu metodu çalıştır.
    ...
    //Kendi oluşturduğumuz türdeki exceptionı handle etme işlemi
